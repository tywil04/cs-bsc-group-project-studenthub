...
import { EmailChallengeStatus, EmailChallengeType, UserEmailStatus } from "@prisma/client";
import nodemailer from "$lib/server/nodemailer";
import { generateRandomString } from "$lib/server/utils";

export const load = async (event) => {
    if (event.locals.currentUser.emailStatus == UserEmailStatus.verified) {
